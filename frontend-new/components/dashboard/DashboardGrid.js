...
import { FiMove, FiActivity, FiX, FiFileText, FiBarChart2, FiTrendingUp } from "react-icons/fi";
    ...
    <div className="widget-header">
      ...
      {showDragHandle && (
        <div className="widget-actions">
          <FiMove size={12} className="drag-handle" style={{ cursor: "move", opacity: 0.6 }} />
        </div>
      )}
    </div>
...
export default function DashboardGrid({ data, type = "commodities" }) {
  ...
  return (
    ...
    >
      ...
      <div key="news">
        <WidgetWrapper title="Bloomberg Intelligence" icon={FiFileText}>
      ...
      {showChart && selectedAsset && (
        <div style={{
          ...
          <div 
            className="analysis-chart-popup"
            style={{
              position: "absolute",
              left: `${chartPos.x}px`,
              top: `${chartPos.y}px`,
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "0.85rem", fontWeight: "600", color: "var(--neon-cyan)" }}>
                <FiActivity size={14} />
