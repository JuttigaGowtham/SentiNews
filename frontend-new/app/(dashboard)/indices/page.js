...
import { FiClock, FiRefreshCw, FiActivity } from "react-icons/fi";
...
export default function IndicesPage() {
  ...
  if (loading) return <LoadingScreen message="Syncing Global Indices Terminal..." />;
      ...
      <div className="dashboard-header">
        <div className="header-title">
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <FiActivity className="accent" size={24} />
